...
const checks = [
  ['main reads YOYO_DEEPSEEK_API_KEY', /YOYO_DEEPSEEK_API_KEY/.test(main)],
  ['main loads dot env', /loadDotEnv/.test(main)],
  ['main exposes ai:yoyo-line', /ai:yoyo-line/.test(main)],
  ['main exposes preference reset', /preferences:reset-behavior/.test(main)],
  ...
  ['daily cards exist', /dailyCards/.test(main) && /memoryCards/.test(settings)],
];
